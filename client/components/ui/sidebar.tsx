...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { title: "AI视频生成", href: "/creator-tools/ai-video", badge: "UPCOMING" },
      { title: "封面图制作", href: "/creator-tools/image-recreation", badge: "UPCOMING" },

      { title: "音视频提取文字", href: "/creator-tools/audio-extract" },
      { title: "账号PK", href: "/creator-tools/account-analysis", badge: "UPCOMING" },
